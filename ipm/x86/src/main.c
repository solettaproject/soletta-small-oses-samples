...
{
    SOL_WRN("x86 receiving consumed confirmation id: %" PRIu32 " %p data: %s OK: %d",
        id, message->mem, message->mem, message == data);
...
timeout_send_cb(void *data)
{
    ...
    sol_ipm_send(MESSAGE_ID, message, consumed_cb, message);
